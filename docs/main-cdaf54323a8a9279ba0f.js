	    ...
	    render() {
	        ...
	        return (React.createElement("div", {className: "input-block"}, 
	            React.createElement("div", {className: "ace-container"}, 
	                React.createElement(react_ace_1.default, {name: this.id, onKeyUp: (o) => this.onSubmit(o), onLoad: (e) => { console.log(e); this.input = e; }, fontSize: 15, className: "ace-input-area", minLines: 3, maxLines: 150, width: "", focus: true, commands: [{
	                        name: "submit",
	                        bindKey: "shift-enter",
	            ...
	            React.createElement("div", {className: "config-box"}, 
	                React.createElement("div", {className: "left"}, 
	                    React.createElement(Visual.Switch, {className: "showAll-switch", checked: showAllAppl, onChange: (b) => { this.setState({ showAllAppl: b }); }, label: "Show all steps"})
	                ), 
	                React.createElement("div", {className: "right"}, 
	                    React.createElement("select", {className: "strategy-select", ref: (s) => this.strategySelect = s, onChange: (sel) => this.setState({ strategy: toStrategy(sel.target.value) })}, 
	                    ...
	                    React.createElement(Visual.ToggleButton, {className: "run-button", checked: !!this.state.evaluating, label: this.state.evaluating ? "Stop \u25FE" : "Run \u25B6", onChange: (b) => { if (b) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	class Reducer {
	    constructor(initLambda, strategy, factory) {
	...
	class CallByNameReduceVisitor extends lambda_1.LambdaVisitor {
	    visit_appl(node) {
	        if (node.isRedex()) {
	            return node;
	        }
	...
	class CallByValueReduceVisitor extends lambda_1.LambdaVisitor {
	    visit_appl(node) {
...
//# sourceMappingURL=main-cdaf54323a8a9279ba0f.js.map